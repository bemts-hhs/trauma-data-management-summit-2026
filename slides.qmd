...
- **Factors**:
  - **RTS**: Measures injury severity based on vital signs.
  - **ISS**: Assesses overall injury severity.
  - **Age Index**: Considers the patient's age.

- **Formula**: Combines these factors to predict survival.
